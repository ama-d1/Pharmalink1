package com.pharmalink.delivery_service.security;
...
public final class AuthContext {
    ...
    // Added 2026-07-23 for the driver-assignment flow — gates
    // accept/status/location endpoints to DRIVER-role callers (or admin,
    // everywhere isAdmin is also checked alongside this).
    public static boolean isDriver(HttpServletRequest request) {
        return "DRIVER".equals(currentRole(request));
    }
