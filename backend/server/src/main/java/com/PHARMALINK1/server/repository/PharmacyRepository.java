...
public interface PharmacyRepository extends JpaRepository<Pharmacy, String> {
    ...
    /**
     * Haversine distance query — returns pharmacies within radiusKm kilometres
     * of (userLat, userLng), ordered nearest first.
     * Uses a subquery so PostgreSQL can reference the computed distance alias.
     */
    @Query(value = """
        SELECT * FROM (
            SELECT *, (
