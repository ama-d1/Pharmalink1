    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // /internal/community/** added for admin-service (step 7c) —
                // moderation reads/deletes live here, not under the public
                // /api/community/** prefix (permitAll + gateway-routed —
                // reachable by any authenticated user, which is fine for
                // browsing but not for deleting other people's posts).
