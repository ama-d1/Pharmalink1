package com.pharmalink.user_profile_service.config;
...
// Phase 1 (extraction) posture — permitAll everywhere, matching the
// monolith's current behavior. Real JWT validation lands centrally at the
// API Gateway (MICROSERVICES_PLAN.md §5.2). /internal/** additionally needs
// network-level restriction later — see InternalProfileController javadoc.
@Configuration
@EnableWebSecurity
