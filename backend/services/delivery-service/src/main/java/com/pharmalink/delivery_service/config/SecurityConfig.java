package com.pharmalink.delivery_service.config;
...
// Phase 1 posture — permitAll, matching every other service. Real
// enforcement happens at the API Gateway's JwtAuthFilter (built in step 6);
// this service, like the rest of the fleet, doesn't yet check the forwarded
// X-User-Id/X-User-Role headers itself — that's a Phase 2 item.
@Configuration
@EnableWebSecurity
